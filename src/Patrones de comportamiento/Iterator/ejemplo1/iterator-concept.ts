/*
En este ejemplo de concepto, creo 4 objetos llamados Aggregate y los agrupo en una colección.

Son objetos muy mínimos que implementan un método que imprime una línea.

Luego creo un Iterable y paso la colección de Agregados.

Ahora puedo atravesar los agregados a través de la interfaz iterable.
*/
