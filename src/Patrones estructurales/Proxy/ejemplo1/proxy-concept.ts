/*
Este ejemplo de concepto simulará un proxy virtual. El sujeto real será llamado a través del proxy. La primera vez que se realiza 
la solicitud, el proxy recuperará los datos del sujeto real. La segunda vez que se llama, devolverá los datos del propio caché del 
proxy que creó a partir de la primera solicitud.
*/
