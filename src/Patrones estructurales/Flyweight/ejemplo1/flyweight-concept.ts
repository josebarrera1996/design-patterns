/*
Se crea un contexto usando la palabra abracadabra.

A medida que se emite, le pregunta a Flyweight Factory por el siguiente carácter. La fábrica Flyweight devolverá un Flyweight existente o creará uno nuevo antes de devolverlo.

abracadabra tiene muchos personajes reutilizados, por lo que solo fue necesario crear 5 flyweights.
*/
